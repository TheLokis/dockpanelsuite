    ...
    internal class VS2012LightAutoHideStrip : AutoHideStripBase
    {
        ...
        private void DrawTab(Graphics g, TabVS2012Light tab)
        {
            ...
            if (tab.Content.DockHandler.IsActivated || tab.IsMouseOver)
                textColor = this.DockPanel.Skin.AutoHideStripSkin.DockStripGradient.StartColor;
            else
                textColor = this.DockPanel.Skin.AutoHideStripSkin.DockStripGradient.EndColor;

            Rectangle rectThickLine = rectTabOrigin;
            rectThickLine.X += _TabGapLeft + _TextGapLeft + _ImageGapLeft + _ImageWidth;
            rectThickLine.Width = TextRenderer.MeasureText(tab.Content.DockHandler.TabText, this.TextFont).Width - 8;
            ...
            if (this.DockPanel.ActiveContent == content || tab.IsMouseOver)
                textColor = this.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveTabGradient.TextColor;
            else
                textColor = this.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.TextColor;
        ...
        {
            Tab tab = this.TabHitTest(ptMouse);
        ...
        {
            GraphicsPath path = this.GetTabOutline((TabVS2012Light)tab, true, true);
        ...
        {
            var tab = (TabVS2012Light)this.TabHitTest(this.PointToClient(MousePosition));
            if (tab != null)
            {
            ...
            if (this.lastSelectedTab != tab)
            {
                if (this.lastSelectedTab != null)
                    this.lastSelectedTab.IsMouseOver = false;
        ...
        protected internal override int MeasureHeight()
        {
            return Math.Max(ImageGapBottom +
                ...
                this.TextFont.Height) + TabGapTop + TabGapBottom;
        }
