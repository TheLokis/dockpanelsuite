...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    internal class VS2013BlueDockPaneStrip : DockPaneStripBase
    {
        ...
        private void CalculateTabs_ToolWindow()
        {
            ...
            foreach (TabVS2013Light tab in this.Tabs)
            {
        ...
        private bool CalculateDocumentTab(Rectangle rectTabStrip, ref int x, int index)
        {
            ...
            var tab = this.Tabs[index] as TabVS2013Light;
        ...
        private void CalculateTabs_Document()
        {
            ...
            {
                int tempX = x;
                var tab = this.Tabs[this.m_startDisplayingTab] as TabVS2013Light;
        ...
        private void DrawTabStrip_Document(Graphics g)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    tabActive = this.Tabs[i] as TabVS2013Light;
                    continue;
                }
                if (rectTab.IntersectsWith(rectTabOnly))
                    this.DrawTab(g, this.Tabs[i] as TabVS2013Light, rectTab);
            }
        ...
        private void DrawTabStrip_ToolWindow(Graphics g)
        {
            ...
            for (int i = 0; i < this.Tabs.Count; i++)
                this.DrawTab(g, this.Tabs[i] as TabVS2013Light, this.GetTabRectangle(i));
        }
        ...
        private Rectangle GetTabRectangle_ToolWindow(int index)
        {
            ...
            TabVS2013Light tab = (TabVS2013Light)(this.Tabs[index]);
        ...
        {
            Rectangle rectTabStrip = this.TabStripRectangle;
            var tab = (TabVS2013Light)this.Tabs[index];
        ...
        private void DrawTab_ToolWindow(Graphics g, TabVS2013Light tab, Rectangle rect)
        {
            ...
            else
            {
                ...
                if (tab.Content == this.DockPane.MouseOverTab)
                    textColor = this.DockPane.DockPanel.Skin.DockPaneStripSkin.ToolWindowGradient.HoverTabGradient.TextColor;
                else
        ...
        private void DrawTab_Document(Graphics g, TabVS2013Light tab, Rectangle rect)
        {
            ...
            Color mouseHoverColor = this.DockPane.DockPanel.Skin.DockPaneStripSkin.DocumentGradient.HoverTabGradient.EndColor;
            ...
            Color lostFocusText = this.DockPane.DockPanel.Skin.DockPaneStripSkin.DocumentGradient.InactiveTabGradient.TextColor;
            Color mouseHoverText = this.DockPane.DockPanel.Skin.DockPaneStripSkin.DocumentGradient.HoverTabGradient.TextColor;
            ...
            if (this.DockPane.ActiveContent == tab.Content)
            {
                ...
                else
                {
                    ...
                    g.DrawImage(rectCloseButton == this.ActiveClose ? Resources.ActiveTabHover_Close : Resources.LostFocusTab_Close, rectCloseButton);
                }
            }
            else
            {
                if (tab.Content == this.DockPane.MouseOverTab)
                {
                    ...
                    TextRenderer.DrawText(g, tab.Content.DockHandler.TabText, this.TextFont, rectText, mouseHoverText, this.DocumentTextFormat);
