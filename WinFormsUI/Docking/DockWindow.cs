...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    public partial class DockWindow : Panel, INestedPanesContainer, ISplitterDragSource
    {
        ...
        protected internal DockWindow(DockPanel dockPanel, DockState dockState)
        {
            ...
            {
                this.m_splitter = this.DockPanel.Extender.DockWindowSplitterControlFactory.CreateSplitterControl();
    ...
    internal class DefaultDockWindow : DockWindow
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (this.DockState == DockState.Document)
                e.Graphics.DrawRectangle(SystemPens.ControlDark, this.ClientRectangle.X, this.ClientRectangle.Y, this.ClientRectangle.Width - 1, this.ClientRectangle.Height - 1);
