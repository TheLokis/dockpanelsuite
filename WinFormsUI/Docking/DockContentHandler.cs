    ...
    public class DockContentHandler : IDisposable, IDockDragSource
    {
        ...
        public bool CloseButton
        {
            ...
            set
            {
                ...
                if (this.IsActiveContentHandler)
        ...
        public bool CloseButtonVisible
        {
            ...
            set
            {
                if (this.m_closeButtonVisible == value)
                    return;
        ...
        {
            get { return this.Pane != null && this.Pane.ActiveContent != null && this.Pane.ActiveContent.DockHandler == this; }
        }
        ...
        {
            get { return this.m_tabText == null || this.m_tabText == "" ? this.Form.Text : this.m_tabText; }
            set
            {
        ...
        internal void SetDockState(bool isHidden, DockState visibleState, DockPane oldPane)
        {
            ...
            if (oldDockState != this.DockState)
            {
                ...
                this.ResetAutoHidePortion(oldDockState, this.DockState);
        ...
        private void ResetAutoHidePortion(DockState oldState, DockState newState)
        {
            ...
            switch (newState)
            {
                ...
                case DockState.DockTopAutoHide:
                    this.AutoHidePortion = this.DockPanel.DockTopPortion;
                    break;
                case DockState.DockLeft:
                case DockState.DockLeftAutoHide:
                    this.AutoHidePortion = this.DockPanel.DockLeftPortion;
                    break;
                case DockState.DockBottom:
                case DockState.DockBottomAutoHide:
                    this.AutoHidePortion = this.DockPanel.DockBottomPortion;
                    break;
                case DockState.DockRight:
                case DockState.DockRightAutoHide:
                    this.AutoHidePortion = this.DockPanel.DockRightPortion;
                    break;
            }
        }
        ...
        public void Show(DockPanel dockPanel)
        {
            ...
            else if (this.DockPanel != dockPanel)
                this.Show(dockPanel, this.DockState == DockState.Hidden ? this.m_visibleState : this.DockState);
            else
                this.Activate();
        }
        ...
        public void DockTo(DockPane pane, DockStyle dockStyle, int contentIndex)
        {
            if (dockStyle == DockStyle.Fill)
            {
                ...
                while (visiblePanes <= contentIndex && convertedIndex < this.Pane.Contents.Count)
                {
                    DockContent window = this.Pane.Contents[convertedIndex] as DockContent;
                ...
                contentIndex = Math.Min(Math.Max(0, convertedIndex-1), this.Pane.Contents.Count - 1);
